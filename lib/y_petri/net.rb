...
# YPetri::Net represents an ordinary Petri net: a collection of places, and
# transitions connecting to these places. The connectors (arcs) are considered
# a property of transitions.
#
module YPetri
  class Net
