...
# Workspace holds places, transitions, nets composed of the former, and assets
# for simulation, along with frugal servicing methods for all of the former.
# Frugal here means fully usable, but with emphasis on simplicity of the
# implementation simplicity and syntactic parsimony.
#
module YPetri
  class Workspace
